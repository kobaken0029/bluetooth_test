package jp.co.koba.bluetoothtest.utils;
...
public class UiUtils {
     ...
     * @param msgId   メッセージID
     */
    public static void showDialog(final Context context, final int msgId, final DialogInterface.OnClickListener listener) {
     ...
     * @param msg     メッセージ
     */
    public static void showDialog(final Context context, final String msg, final DialogInterface.OnClickListener listener) {
        new Handler(Looper.getMainLooper()).post(new Runnable() {
            @Override
            public void run() {
                new AlertDialog.Builder(new ContextThemeWrapper(context, R.style.AppTheme))
